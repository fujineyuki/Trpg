...
public class Syozi_ListActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_syozi_list);


        if(helper == null){
            helper = new Syozi_MemoOpenHelper(Syozi_ListActivity.this);
        }
        ...
        try {
            ...
            Cursor c = db.rawQuery("select uuid, body from SYOZI_TABLE order by id", null);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener(){
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(Syozi_ListActivity.this, Syozi_CreateMemoActivity.class);
...
//                TextView idTextView = (TextView)two.findViewById(android.R.id.text2);
        ...
        listView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener(){
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                SQLiteDatabase db = helper.getWritableDatabase();
                try {
                    db.execSQL("DELETE FROM SYOZI_TABLE WHERE uuid = '"+ idStr + s +"'");
                } finally {
                    db.close();
                }
