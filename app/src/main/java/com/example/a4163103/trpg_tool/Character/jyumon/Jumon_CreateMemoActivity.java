...
public class Jumon_CreateMemoActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jyumon_create_memo);

        if(helper == null){
            helper = new Jumon_MemoOpenHelper(Jumon_CreateMemoActivity.this);
        }
        ...
        if(id.equals("")){
            ...
            try {
                ...
                Cursor c = db.rawQuery("select body from JUMON_TABLE where uuid = '"+ id +"'", null);
            ...
            public void onClick(View v) {
                ...
                try {
                    if(newFlag){
                        ...
                        db.execSQL("insert into JUMON_TABLE(uuid, body) VALUES('"+ id +"', '"+ bodyStr +"')");
                    }else{

                        db.execSQL("update JUMON_TABLE set body = '"+ bodyStr +"' where uuid = '"+id+"'");
                    }
                } finally {
...
//                startActivity(intent);
                ...
                Intent intent1 = new Intent(getApplication(), Jumon_ListActivity.class);
